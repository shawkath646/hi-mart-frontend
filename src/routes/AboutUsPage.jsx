    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          ...
          >
            {[
              { icon: <FiGlobe size={32} />, title: "Global Reach", desc: "Serving customers worldwide" },
              { icon: <FiShoppingBag size={32} />, title: "100K+ Products", desc: "Wide variety of categories" },
              { icon: <FiUsers size={32} />, title: "10K+ Sellers", desc: "Growing merchant community" },
              { icon: <FiAward size={32} />, title: "Quality Assurance", desc: "Verified products & sellers" }
            ].map((item, index) => (
              <motion.div 
                key={index}
                whileHover={{ y: -5 }}
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <FiCode size={48} className="mx-auto mb-6" />

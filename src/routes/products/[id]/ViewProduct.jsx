...
import ViewProductSkeleton from './ViewProductSkeletion';
...
const ViewProductPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{product.title} | HiMart</title>
            </Helmet>
                        ...
                        <div className="lg:w-1/2 space-y-6">
                            ...
                            <div className="rounded-2xl shadow-lg p-8 bg-white dark:bg-gray-800 ring-1 ring-gray-200 dark:ring-gray-700">
                                ...
                                {product.keywords?.length > 0 && (
                                    <div className="mt-6">
                                        <h3 className="text-gray-500 dark:text-gray-400 font-medium mb-2">Keywords</h3>
                                        <div className="flex flex-wrap gap-2">
                                            {product.keywords.map((keyword, index) => (
                                                <span
                                                    key={index}
                                                    className="inline-block bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300 text-xs font-medium px-3 py-1 rounded-full shadow-sm transition-all hover:scale-105"
                                                >
                                                    {keyword}
                                                </span>
                                            ))}

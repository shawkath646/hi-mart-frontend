...
const BecomeSellerPage = () => {
    ...
    if (session && session.user && session.user.isSeller) return navigate("/seller/dashboard", { replace: true });
    ...
    return (
        <>
            <Helmet>
                <title>Become a Seller | HiMart</title>
            </Helmet>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        >
                            ...
                            <div className="space-y-5">
                                {[
                                    {
                                        icon: <FaStore aria-hidden className="text-blue-500 dark:text-blue-400 text-xl" />,
                                        title: "Easy Setup",
                                        text: "Get your store running in minutes with our simple onboarding"
                                    },
                                    {
                                        icon: <FaChartLine aria-hidden className="text-blue-500 dark:text-blue-400 text-xl" />,
                                        title: "Growing Marketplace",
                                        text: "Access millions of active buyers on our platform"
                                    },
                                    {
                                        icon: <FaWallet aria-hidden className="text-blue-500 dark:text-blue-400 text-xl" />,
                                        title: "Competitive Fees",
                                        text: "Low commission rates with no hidden charges"
                                    },
                                    {
                                        icon: <FaShieldAlt aria-hidden className="text-blue-500 dark:text-blue-400 text-xl" />,
                        ...
                        ${activeStep > step ? 'cursor-pointer' : 'cursor-default'}`}
                                            >
                                                {activeStep > step ? <FaCheck aria-hidden /> : step}
                                            </button>
                                        ...
                                        ${isSubmitting ? 'bg-green-500' : 'bg-green-600 dark:bg-green-500'} text-white hover:bg-green-700 dark:hover:bg-green-600 transition-colors`}
                                                    >
                                                        {isSubmitting ? (
                                                            ...
                                                            <>
                                                                Submit Application <FaCheck aria-hidden />
                                                            </>
                                                        )}
                                                    </button>
                                                </div>

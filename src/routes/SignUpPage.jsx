                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <FaGlobeAmericas className="text-gray-400 dark:text-gray-500" />
                                        </div>
                                        <select
                                            id="country"
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="relative flex-1">
                                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <FaPhone className="text-gray-400 dark:text-gray-500 text-sm" />
                                            </div>
                                            <input
                                                id="phoneNumber"
                                                type="tel"
                            ...
                            <div className="mt-4 text-center text-xs">
                                <p className="text-gray-600 dark:text-gray-400">
                                    ...
                                    <a href="/signin" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                                        Sign in
                                    </a>
                                </p>
                            </div>

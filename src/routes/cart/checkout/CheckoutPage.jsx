    ...
    const paymentMethods = [
        {
            ...
            icon: <FaCreditCard aria-hidden className="text-blue-500" size={24} />,
            description: 'Pay with Visa, Mastercard, or other cards'
        },
        {
            id: 'google',
            name: 'Google Pay',
            icon: <FaGoogle aria-hidden className="text-red-500" size={24} />,
            description: 'Fast checkout with Google'
        },
        {
            id: 'kakao',
            name: 'KakaoPay',
            icon: <SiKakaotalk aria-hidden className="text-yellow-400" size={24} />,
            description: 'Fast payment with KakaoPay'
        },
        {
            id: 'naver',
            name: 'Naver Pay',
            icon: <SiNaver aria-hidden className="text-green-500" size={24} />,
            description: 'Pay with your Naver account'
        },
        {
            id: 'paypal',
            name: 'PayPal',
            icon: <FaPaypal aria-hidden className="text-blue-700" size={24} />,
            description: 'Pay with your PayPal account'
        },
        {
            id: 'samsung',
            name: 'Samsung Pay',
            icon: <SiSamsungpay aria-hidden className="text-blue-800" size={24} />,
            description: 'Pay with your Samsung device'
        },
        {
            id: 'toss',
            name: 'Toss Pay',
            icon: <FaRegCreditCard aria-hidden className="text-blue-400" size={24} />,

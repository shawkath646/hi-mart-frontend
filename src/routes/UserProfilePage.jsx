...
const UserProfilePage = () => {
  ...
  // Sample user data
  const user = {
    "id": "MkdoWfAfvbSwLrHVuF9E",
    "firstName": "Shawkat Hossain",
    "lastName": "Maruf",
    "dateOfBirth": "2005-12-30",
    "email": "shawkath646@gmail.com",
    "emailVerified": false,
    "phoneNumber": "1048376284",
    "joinedOn": {
      "_seconds": 1748392625,
    ...
    "paymentMethods": [],
    "googleId": "102574858085144123626",
    "picture": "https://lh3.googleusercontent.com/a/ACg8ocJcfwh7FLDi1F4JqpSvuq6ndSh494OGk6_UnareRmhqGiQelGOg=s96-c",
    "isSeller": true
  };
  ...
  return (
    <main className="min-h-screen bg-gray-100 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
              ...
              <div className="flex items-center space-x-4 mb-4 sm:mb-0">
                ...
                <div>
                  ...
                  <p className="text-blue-100 dark:text-blue-200">
                    {user.isSeller ? 'Seller' : 'Buyer'} • Joined {formatJoinDate(user.joinedOn)}
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  ...
                  {editMode ? (
                    ...
                    <>
                      <ProfileField label="First Name" value={user.firstName} icon={FaUser} />
                      <ProfileField label="Last Name" value={user.lastName} icon={FaUser} />
                      <ProfileField label="Date of Birth" value={new Date(user.dateOfBirth).toLocaleDateString()} icon={FaBirthdayCake} />
                    </>
                  )}
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  ...
                  {editMode ? (
                    ...
                    <>
                      ...
                      <ProfileField label="Phone Number" value={user.phoneNumber} icon={FaPhone} />
                    </>
                  )}
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg md:col-span-2">
                  ...
                  {editMode ? (
                    ...
                    <div className="space-y-2">
                      <ProfileField label="Street" value={user.addresses[0].street} icon={FaMapMarkerAlt} />
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                        <ProfileField label="City" value={user.addresses[0].city} />
                        <ProfileField label="State" value={user.addresses[0].state} />
                        <ProfileField label="Postal Code" value={user.addresses[0].postalCode} />
                        <ProfileField label="Country" value={user.addresses[0].country} />
                      </div>
                    </div>
                  )}
                </div>
